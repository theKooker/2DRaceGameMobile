...
| `adid` | string | `"adid": "12345678"` | Bidder-generated ID of a pre-loaded ad to be served if the bid wins.<br><br>**Note**: This attribute is **required** in the response. |
...
| `crtype` | string | `"crtype": "VAST` | The creative type of the ad asset. The following types are valid:<br><br><ul><li>`VAST`</li><li>`MRAID playable`</li><li>`MRAID video`</li><li>`MRAID AR`</li><li>`HTML`</li></ul><br><br>**Note**: This attribute is **required** in the response. |
